...
function wpamms_adminmembers_menu() {
	add_menu_page( 'Member Management',
...
function wpamms_membermanagement_page() {
	...
	<?php if ( empty( $_GET['id'] ) ) { ?>
            ...
            <table class="wp-list-table widefat fixed" >
                <thead><tr>
                    ...
                    <th>Institution | Department | Address | City | Province | Postal Code | Email Address | Phone Number | Gender | Research Focus</th>
                    <th style="width: 80px">Photo | Payment Receipt</th>
            ...
            <?php 
                    ...
                    if ( $members_data ) {
                            foreach ( $members_data as $member_data ) {
                                    ...
                                    echo '<td>' . $member_data['institution'] . ' | ' 
	...
	<input name="importmembersfile" type="file" /> <br /><br />
	...
	<?php } elseif ( isset( $_GET['id'] ) && ( $_GET['id'] == "new" || is_numeric( $_GET['id'] ) ) ) {
		...
		<table>
			...
			<tr>
				...
				<td><input type="text" name="paymentreceipt" size="80" class="amms_tooltip" title="Enter an image URL of member's PAYMENT RECEIPT, or click 'Choose a File' button to upload a new one " value="<?php echo esc_attr( $member_data['paymentreceipt'] ); ?>" />
                                    <input name="filePaymentReceiptToUpload" type="file" accept="image/*" />
                                    <br/>(Enter an image URL of member's PAYMENT RECEIPT, or click "Choose a File" button to upload a new one)</td>
			</tr>
			<tr>
				<td>Member Since</td>
